...
{
  auto advance_x = static_cast<float>(glyph_slot->advance.x) / 64;
  auto advance_y = static_cast<float>(glyph_slot->advance.y) / 64;
  ...
  file << "#ifndef GLYPH_SDF_BITMAP_H\n"
       ...
       << "#define Glyph_Font_Ascender " << ascender                << "\n"
       << "#define Glyph_Font_Height "   << height                  << "\n"
